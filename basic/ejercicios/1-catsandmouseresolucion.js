 ...
 */
 ...
 const catAndMouse = (catA,catB,mouseC) => {
    let distanciaAaC = Math.abs(catA-mouseC);
    let distanciaBaC = Math.abs(catB-mouseC);
    if(distanciaBaC > distanciaAaC) return "Cat A";
    else if(distanciaAaC > distanciaBaC) return "Cat B";
    else return "Mouse C"
 };

console.log(catAndMouse(5,2,0));